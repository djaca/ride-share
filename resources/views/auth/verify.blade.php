        ...
        <div class="rounded shadow">
            ...
            <div class="bg-white p-3 rounded-b">
                ...
                <p class="text-grey-dark">
                    ...
                    {{ __('If you did not receive the email') }}, <a href="{{ route('verification.resend') }}" class="no-underline hover:underline text-brand-darker">{{ __('click here to request another') }}</a>.
                </p>
            </div>
        </div>
    </div>
