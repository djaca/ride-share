...
Vue.component('v-flash', __webpack_require__(44));
Vue.component('enroute-cities', __webpack_require__(47));

Vue.component('v-cities-autocomplete', __webpack_require__(54));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_flatpickr__ = __webpack_require__(38);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js!./material_blue.css", function() {
			var newContent = require("!!../../../css-loader/index.js!./material_blue.css");
...
Component.options.__file = "resources/js/components/VFlash.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-476a6a45", Component.options)
  } else {
    hotAPI.reload("data-v-476a6a45", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    classes: function classes() {
      var defaults = ['mb-1', 'p-4', 'border', 'text-brand-lightest'];
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-476a6a45", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-166dfdce"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/EnrouteCities.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-166dfdce", Component.options)
  } else {
    hotAPI.reload("data-v-166dfdce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(50)("830956e8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-166dfdce\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EnrouteCities.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-166dfdce\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EnrouteCities.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.old) {
      this.old.forEach(function (id) {
        axios.get('/api/cities/' + id).then(function (response) {
          _this.city.push(response.data);
          _this.selectedCities.push(response.data);
        });
      });
  ...
  methods: {
    asyncFind: function asyncFind(query) {
      ...
      axios.get('/api/cities', { params: { keywords: query } }).then(function (response) {
        _this2.isLoading = false;

        _this2.options = response.data.map(function (city) {
          return {
            id: city.id,
            name: city.name
          };
    ...
    updateHiddenInput: function updateHiddenInput(value) {
      this.multiple ? this.selectedCities.push(value) : this.selectedCities = [value];
    },
    removeOption: function removeOption(removedOption) {
      this.selectedCities.splice(this.selectedCities.findIndex(function (c) {
        return c.id === removedOption.id;
      }), 1);
    }
  }
});
      ...
      _c(
        ...
        [
          _c("span", { attrs: { slot: "noResult" }, slot: "noResult" }, [
            _vm._v("Oops! No city found.")
          ])
        ]
      ),
      _vm._v(" "),
      _vm._l(_vm.selectedCities, function(city) {
        return _c("input", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-166dfdce", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/VCitiesAutocomplete.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0545b74c", Component.options)
  } else {
    hotAPI.reload("data-v-0545b74c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.oldValue) {
      axios.get('/api/cities/' + this.oldValue).then(function (response) {
  ...
  watch: {
    city: function city(_city) {
      this.$emit('city-changed', { city: _city });
    }
  },
...
var render = function() {
  ...
  return _c(
    ...
    [
              ...
              fn: function(props) {
                return [
                  _c("div", { staticClass: "option__desc" }, [
                    ...
                    _vm._v(" "),
                    _c("span", { staticClass: "option__small text-xs" }, [
                      _vm._v(_vm._s(props.option.country))
                    ])
                  ])
                ]
              }
      ...
      _c("input", {
        attrs: { type: "hidden", name: _vm.name },
        domProps: { value: _vm.setInputValue }
      })
    ],
    1
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0545b74c", module.exports)
  }
}
